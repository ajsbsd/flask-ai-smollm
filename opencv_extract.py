...
def extract_frames_from_time_range(video_path, start_time_seconds, duration=10, num_frames=4, output_dir="extracted_frames"):
    """
    ...
    frame_indices = [int(start_frame + i * (end_frame - start_frame) / max(num_frames - 1, 1)) 
    ...
    for i, frame_idx in enumerate(frame_indices):
        ...
        if ret:
            ...
            output_path = os.path.join(output_dir, f"theo_frame_{i+1}_{timestamp:.2f}s.jpg")
